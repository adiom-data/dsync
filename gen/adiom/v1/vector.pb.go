...
func file_adiom_v1_vector_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_adiom_v1_vector_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*GetChunkedRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_adiom_v1_vector_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Chunked); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_adiom_v1_vector_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GetChunkedResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_adiom_v1_vector_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_adiom_v1_vector_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_adiom_v1_vector_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_adiom_v1_vector_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*GetSupportedDataTypesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_adiom_v1_vector_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*GetSupportedDataTypesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
