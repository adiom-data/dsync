...
// PerformFlowIntegrityCheck provides a mock function with given fields: _a0, _a1
func (_m *Coordinator) PerformFlowIntegrityCheck(_a0 context.Context, _a1 iface.FlowID) (iface.FlowDataIntegrityCheckResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, iface.FlowID) (iface.FlowDataIntegrityCheckResult, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, iface.FlowID) iface.FlowDataIntegrityCheckResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(iface.FlowDataIntegrityCheckResult)
	}

	if rf, ok := ret.Get(1).(func(context.Context, iface.FlowID) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
