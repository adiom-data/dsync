...
type ConnectorICoordinatorSignal interface {
	...
	RequestDataIntegrityCheck(flowId FlowID, readPlan ConnectorReadPlan, options ConnectorOptions) error // Request a data integrity check based on a read plan (async)
