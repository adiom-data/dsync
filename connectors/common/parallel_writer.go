...
func NewParallelWriter(ctx context.Context, connector ParallelWriterConnector, numWorkers int, maxBatchSize int, namespaceStreamWriter []string) *ParallelWriter {
	m := map[string]int{}
