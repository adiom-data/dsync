...
type ConnectorICoordinatorSignal interface {
	...
	RequestDataIntegrityCheck(flowId FlowID, options ConnectorOptions, readPlan ConnectorReadPlan) error // Request a data integrity check based on a read plan (async)
