...
// GetChunk implements adiomv1connect.ChunkingServiceHandler.
func (s *simple) GetChunk(ctx context.Context, r *connect.Request[adiomv1.GetChunkRequest]) (*connect.Response[adiomv1.GetChunkResponse], error) {
	...
	return connect.NewResponse(&adiomv1.GetChunkResponse{
		Data: chunked,
	}), nil
}
