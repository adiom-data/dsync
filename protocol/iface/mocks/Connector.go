...
func (_m *Connector) RequestDataIntegrityCheck(flowId iface.FlowID, options iface.ConnectorOptions) error {
	ret := _m.Called(flowId, options)
...
// SetParameters provides a mock function with given fields: reqCap
func (_m *Connector) SetParameters(reqCap iface.ConnectorCapabilities) {
	_m.Called(reqCap)
}
