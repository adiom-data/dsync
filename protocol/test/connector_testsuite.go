...
/*
* Check read resumability for the initial data copy
*
* Scenario:
 ...
 */
// 1) , then resumed, then check that (a) none of the already executed task ids were executed again and (b) the unexecuted task IDs were executed (c) r
